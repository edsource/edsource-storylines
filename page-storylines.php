...
=================================================*/
	print '<section id="slick-body">';
		...
		print '<div id="slick-intro">';
			...
			if(have_posts()) { while(have_posts()) { the_post();print slick_byline($post->ID, get_the_modified_date('F j, Y'));print '<br>';print slick_social($post->ID, 'Storylines', 'Check out %23Storylines: Following the evolution of stories over time.', 'Check out Storylines: Following the evolution of stories over time.');
